...
def main(limit):
    for i in range(1, limit):
        ...
        email = 'gnarlynarwhal1+{}@gmail.com'.format(getrandbits(40)) # CHANGE YOUR_EMAIL to your email prefix. don't change the +{} after.
        payload = {
            'name': 'Jakrarat Chunnananda',
            'email': email, # DO NOT CHANGE - You will get emails from YME , be careful
            'Kid 20-27 or Unisex UK 4-12': '7.5',
